<div class="panel pb-4">
    <form id="eb_deathcase_investigation" method="post" enctype="multipart/form-data">
        ...
        <div class="panel-body" style="padding-top:0px; padding-bottom: 0px;">
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control editable-field" id="policytype" name="policytype" <?php echo isset($essentialdata->policytype) ? 'disabled' : ''; ?>>
                            ...
                            <option value="Persnal accident" <?php echo ($essentialdata->policytype ?? '') == 'Persnal accident' ? 'selected' : ''; ?>>Persnal accident</option>
                            <option value="Motor vehicle TP" <?php echo ($essentialdata->policytype ?? '') == 'Motor vehicle TP' ? 'selected' : ''; ?>>Motor vehicle TP</option>
                            <option value="Workman compulsation" <?php echo ($essentialdata->policytype ?? '') == 'Workman compulsation' ? 'selected' : ''; ?>>Workman Compensation</option>
            ...
            <div class="button d-flex justify-content-end" style="padding-bottom:10px;">
                <input class="btn case_btn" type="button" value="<?php echo isset($essentialdata) ? "Edit" : "Next"; ?>" id="eb_deathcase_investigation_submit">
            </div>
        </div>
    </form>
</div>