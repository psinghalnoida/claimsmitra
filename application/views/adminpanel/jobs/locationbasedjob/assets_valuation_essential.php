<div class="panel pb-4">
    <form id="assets_valuation_essential_data" method="post" enctype="multipart/form-data">
        ...
        <div class="panel-body" style="padding-top:0px; padding-bottom: 0px;">
            ...
            <div class="button d-flex justify-content-end" style="padding-bottom:10px;">
                <input class="btn case_btn toggle-edit" type="button" value="<?php echo isset($essentialdata) ? "Edit" : "Next"; ?>" id="assets_valuation_submit">
            </div>
        </div>
    </form>
</div>