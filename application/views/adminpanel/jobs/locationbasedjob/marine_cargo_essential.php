<div class="panel ">
    <form id="marine_cargo_essential" method="post" enctype="multipart/form-data">
        ...
        <div class="panel-body" style="padding-top:0px; padding-bottom: 0px;">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-4 ">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control editable-field" <?php echo isset($essentialdata->policyNumber) ? "disabled" : "enable"; ?> value="<?php echo isset($essentialdata->policyNumber) && !empty($essentialdata->policyNumber) ? $essentialdata->policyNumber : (isset($jobdata->policyNumber) ? $jobdata->policyNumber : ""); ?>" id="policyNumber" name="policyNumber" placeholder="Policy Number">
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-md-4 ">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control editable-field" <?php echo isset($essentialdata->vehicle_number) ? "disabled" : "enable"; ?> value="<?php echo isset($essentialdata->vehicle_number) && !empty($essentialdata->vehicle_number)? $essentialdata->vehicle_number: (isset($jobdata->vehicle_number) ? $jobdata->vehicle_number : ""); ?>" id="vehicle_number" name="vehicle_number" placeholder="Vehicle Number">
                    </div>
                </div>
                <div class="col-xl-4 col-md-4 ">
                    <div class="form-group">
                        <label for="cause_loss" style="color:black">Cause of Loss &nbsp;<span style="color:red">*</span></label>
                        <input type="text" class="form-control editable-field" <?php echo isset($essentialdata->cause_loss) ? "disabled" : "enable"; ?> value="<?php echo isset($essentialdata->cause_loss) && !empty($essentialdata->cause_loss)? $essentialdata->cause_loss: (isset($jobdata->cause_loss) ? $jobdata->cause_loss : ""); ?>" id="cause_loss" name="cause_loss" placeholder="Cause of Loss">
                    </div>
                </div>
            ...
            <div class="button d-flex justify-content-end" style="padding-bottom:10px;">
                <input class="btn case_btn" type="button" value="<?php echo isset($essentialdata) ? "Edit" : "Next"; ?>" id="marine_cargo_submit">
            </div>
        </div>
    </form>
</div>