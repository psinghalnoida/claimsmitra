<div class="panel ">
    <form id="miscellaneous_essential" method="post" enctype="multipart/form-data">
        ...
        <div class="panel-body" style="padding-top:0px; padding-bottom: 0px;">
            ...
            <div class="col-xl-4 col-md-4">
                <div class="form-group">
                    <label for="contact_person_name" style="color:black">Claimant Name<span style="color:red">*</span></label>
            ...
            <div class="col-xl-4 col-md-4">
                <div class="form-group">
                    <label for="contact_person_mobile" style="color:black">Claimant Mobile<span style="color:red">*</span></label>
                ...
                <div class="col-xl-4 col-md-4 ">
                 ...
                 <div class="col-xl-4 col-md-4 ">
                    <div class="form-group">
                        <label for="policy_report" style="color:black">Police Report &nbsp;<span style="color:red">*</span></label>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control editable-field natureofloss" id="natureofloss" name="natureofloss" <?php echo isset($essentialdata->natureofloss) ? 'disabled' : ''; ?>>
                            <option value="">Select</option>
                 ...
                 <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control editable-field policytype" id="policytype" name="policytype" <?php echo isset($essentialdata->policytype) ? 'disabled' : ''; ?>>
                            <option value="">Select</option>
                ...
                <div class="col-xl-4 col-md-4"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                            class="form-control otherPolicyTypeDiv editable-field"
                            id="otherPolicyType"
                ...
                <div class="col-xl-4 col-md-4"
                    ...
                    <div class="form-group">
                        <label for="other_nature_Type editable-field" style="color:black">
                            Specify Other Nature of Job
                        </label>
                        <input type="text"
                            class="form-control editable-field other_nature_Type"
             ...
             <div class="col-xl-4 col-md-4 ">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control editable-field" <?php echo isset($essentialdata->remark) ? "disabled" : "enable"; ?> value="<?php echo isset($essentialdata->remark) ? $essentialdata->remark : ""; ?>" id="remark" name="remark" placeholder="Remark">
                    </div>
                </div>
            </div>
...
<script>
     ...
     $('.natureofloss').on('change', function () {
            if ($(this).val() === 'Other') {
                $('.other_nature_Type').show(); // Show the "Other" field
            } else {
                $('.other_nature_Type').hide(); // Hide the "Other" field
