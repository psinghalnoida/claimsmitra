<div class="panel ">
    <form id="paclaim_essential" method="post" enctype="multipart/form-data">
        ...
        <div class="panel-body" style="padding-top:0px; padding-bottom: 0px;">
            ...
            <div class="row my-3">
                ...
                <div class="col-xl-2 col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control editable-field" <?php echo isset($essentialdata->policyNumberfrom) ? "disabled" : "enable"; ?> value="<?php echo isset($essentialdata->policyNumberfrom) ? format_date($essentialdata->policyNumberfrom, 'd-m-Y') : ""; ?>" id="policyNumberfrom" name="policyNumberfrom" placeholder="From">
                    </div>
                </div>
                <div class="col-xl-2 col-md-2">
                    <div class="form-group">
                        <label for="policyNumberto" style="color:black">Policy Number(To) </label>
                        <input type="text" class="form-control editable-field" <?php echo isset($essentialdata->policyNumberto) ? "disabled" : "enable"; ?> value="<?php echo isset($essentialdata->policyNumberto) ? format_date($essentialdata->policyNumberto, 'd-m-Y') : ""; ?>" id="policyNumberto" name="policyNumberto" placeholder="To">
                    </div>
                </div>
                <div class="col-xl-4 col-md-4 ">
                    <div class="form-group">
            ...
            <div class="button d-flex justify-content-end" style="padding-bottom:10px;">
                <input class="btn case_btn" type="button" value="<?php echo isset($essentialdata) ? "Edit" : "Next"; ?>" id="paclaim_submit">
            </div>
        </div>
    </form>
</div>
