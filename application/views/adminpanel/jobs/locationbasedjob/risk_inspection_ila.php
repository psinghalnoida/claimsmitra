...
<body>
    <div class="flyleaf">
        ...
        <div class="head" style="text-align:right;margin-left:15%; margin-top:-30px; ">
            <h3 style="font-weight: 400; margin-bottom: 1px;">Risk Inspection</h3>
        </div>
        <table>
            ...
            <?php if (!empty($essentialData['insured_name'])) { ?>
                <tr>
                    <td>Name of proposer / Insured</td>
            ...
            <?php } ?>
             <?php if (!empty($essentialData['insurer'])) { ?>
                <tr>
                    <td>Insurer</td>
                    <td ><?php echo $essentialData['insurer']; ?></td>
                </tr>
            <?php } ?>
             <?php if (!empty($essentialData['broker_no'])) { ?>
                <tr>
                    <td>Broker No.</td>
                    <td ><?php echo $essentialData['broker_no']; ?></td>
                </tr>
            <?php } ?>
             <?php if (!empty($essentialData['sum_insured'])) { ?>
                <tr>
                    <td>Sum insured</td>
