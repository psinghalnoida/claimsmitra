<div class="panel ">
    <form id="engineering_preins_essential" method="post" enctype="multipart/form-data">
        ...
        <div class="panel-body" style="padding-top:0px; padding-bottom: 0px;">
           ...
           <!--  <div class="row my-3">
                  ...
                  <div class="col-xl-4 col-md-4 ">
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            <?php echo isset($essentialdata->insured_name) ? "disabled" : "enable"; ?> 
                            value="<?php 
                                echo isset($essentialdata->insured_name) && !empty($essentialdata->insured_name) 
                                    ? $essentialdata->insured_name 
                                    : (isset($jobdata->insured_name) ? $jobdata->insured_name : ''); 
                            ?>" 
                            id="insured_name" 
                            name="insured_name" 
            ...
            <div class="row my-3"> 
                ...
                <div class="col-xl-4 col-md-4 ">
                    <div class="form-group">
                        <label for="casetype" style="color:black">Type of Case </label>
                        <input type="text" class="form-control editable-field" <?php echo isset($essentialdata->casetype) ? "disabled" : "enable"; ?> value="<?php echo isset($essentialdata->casetype) ? $essentialdata->casetype : ""; ?>" id="casetype" name="casetype" placeholder="Type of Case">
                    </div>
                </div>
                <div class="col-xl-4 col-md-4 ">
                    <div class="form-group">
                        <label for="survey_data" style="color:black">Date of Survey</label>
                        <input type="date" class="form-control editable-field" <?php echo isset($essentialdata->survey_data) ? "disabled" : "enable"; ?> value="<?php echo isset($essentialdata->survey_data) ? format_date($essentialdata->survey_data, 'd-m-Y') : ""; ?>" id="survey_data" name="survey_data" placeholder="Date of Survey">
                    </div>
                </div>
            </div>
            <div class="row my-3">
            ...
            <div class="button d-flex justify-content-end" style="padding-bottom:10px;">
                <input class="btn case_btn" type="button" value="<?php echo isset($essentialdata) ? "Edit" : "Next"; ?>" id="engineering_preins_submit">
            </div>
        </div>
    </form>
</div>
