...
<div class="panel ">
    <div class="panel-heading  pt-4 Essential_heading" style="padding-left:0px; font-size:14px; color:#232A2B;font-weight:700;">Marine Cargo</div>
         ...
         <div class="row my-3">
            ...
            <div class="row my-3">
               <div class="col-xl-4 col-md-4">
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="dv_submission_date" style="color:black">Consignee &nbsp;<span style="color:red">*</span></label>
                        <input type="text" class="form-control editable-field " value="" name="dv_submission_date" id="dv_submission_date" placeholder="Consignee" >
                    </div>
                </div>   
            </div>
            <div class="row my-3">
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="goods_damaged" style="color:black">Goods Damaged &nbsp;<span style="color:red">*</span></label>
                        <input type="text" class="form-control editable-field " value="" name="goods_damaged" id="goods_damaged" placeholder="Goods Damaged" >
                    </div>
                </div>    
            </div>
            <div class="row my-3">
            ...
            <div class="row my-3">
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control editable-field " value="" name="policyNumber" id="policyNumber" placeholder="Policy No." >
                    </div>
                </div>
            ...
            <!-- <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control editable-field " value="" name="cause_of_loss" id="cause_of_loss" placeholder="Cause of Loss" >
                    </div>
                </div> -->
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
               ...
               <div class="col-xl-4 col-md-4">
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control editable-field " value="" name="consignment_courie" id="consignment_courie" placeholder="Consignment Courier Receipt / BL / AWB /LR / GRN / Postal No." >
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
            ...
            <div class="row my-3">
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control editable-field " value="" name="invoice_stn_no" id="invoice_stn_no" placeholder="Driver License No" >
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
            ...
            <div class="row my-3">
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control editable-field " value="" name="salvage_amount" id="salvage_amount" placeholder="Salvage expected" >
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
            ...
            <div class="row my-3">
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control editable-field " value="" name="description" id="description" placeholder="Description" >
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
            ...
            <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="nature_of_loss" style="color:black">Nature of Loss</label>
            ...
            <div class="row my-3">
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="reason_for_delay_ila" style="color:black">Reason for delay in ILA submission</label>
                        <input type="text" class="form-control editable-field " value="" name="reason_for_delay_ila" id="reason_for_delay_ila" placeholder="Reason for delay in ILA submission" >
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="surveyor_appointment_by" style="color:black">Surveyor Appointed by</label>
                        <input type="text" class="form-control editable-field " value="" name="surveyor_appointment_by" id="surveyor_appointment_by" placeholder="Surveyor Appointed by" >
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="transporter_name" style="color:black">Transporter Name</label>
                        <input type="text" class="form-control editable-field " value="" name="transporter_name" id="transporter_name" placeholder="Transporter Name" >
                    </div>
                </div> 
            </div>
            ...
            <div class="row my-3">
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="vehicle_registration_number" style="color:black">Vehicle Registration Number</label>
                        <input type="text" class="form-control editable-field " value="" name="vehicle_registration_number" id="vehicle_registration_number" placeholder="Vehicle Registration Number" >
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="vehicle_gross_weight" style="color:black">Vehicle gross weight</label>
                        <input type="text" class="form-control editable-field " value="" name="vehicle_gross_weight" id="vehicle_gross_weight" placeholder="Vehicle gross weight" >
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="vehicle_unladen_weight" style="color:black">Vehicle unladen weight</label>
                        <input type="text" class="form-control editable-field " value="" name="vehicle_unladen_weight" id="vehicle_unladen_weight" placeholder="Vehicle unladen weight" >
                    </div>
                </div>  
            </div>
            ...
            <div class="row my-3">
               <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="vehicle_laden_weight" style="color:black">Vehicle laden weight</label>
                        <input type="text" class="form-control editable-field " value="" name="vehicle_laden_weight" id="vehicle_laden_weight" placeholder="Vehicle laden weight" >
                    </div>
                </div> 
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="cargo_arrival_date" style="color:black">Cargo Arrival Date</label>
                        <input type="text" class="form-control editable-field " value="" name="cargo_arrival_date" id="cargo_arrival_date" placeholder="Cargo Arrival Date" >
                    </div>
                </div>  
            </div>
            ...
            <div class="row my-3">
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="cargo_delivery_taken_date" style="color:black">Cargo delivery taken date</label>
                        <input type="text" class="form-control editable-field " value="" name="cargo_delivery_taken_date" id="cargo_delivery_taken_date" placeholder="Cargo Delivery Taken Date" >
                    </div>
                </div> 
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="date_of_loss_noticed" style="color:black">Date of loss noticed</label>
                        <input type="text" class="form-control editable-field " value="" name="date_of_loss_noticed" id="date_of_loss_noticed" placeholder="Date of Loss Noticed" >
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="date_of_loss_intimation" style="color:black">Date of loss intimation to of insurer</label>
                        <input type="text" class="form-control editable-field " value="" name="date_of_loss_intimation" id="date_of_loss_intimation" placeholder="Date of loss intimation to of insurer" >
                    </div>
                </div>  
            </div>
            ...
            <div class="row my-3">              
                <div class="col-xl-4 col-md-4">
                   <div class="form-group">
                        <label for="all_documents_submitted" style="color:black">All documents submitted by insured / claimant on</label>
                        <input type="text" class="form-control editable-field " value="" name="all_documents_submitted" id="all_documents_submitted" placeholder="All documents submitted by insured / claimant on" >
                    </div>
                </div> 
                <div class="col-xl-4 col-md-4">
                   <div class="form-group">
                        <label for="documents_submitted" style="color:black">Documents submitted</label>
                        <input type="text" class="form-control editable-field " value="" name="documents_submitted" id="documents_submitted" placeholder="Documents submitted" >
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                   <div class="form-group">
                        <label for="documents_pending_request" style="color:black">Documents Pending / Requested</label>
                        <input type="text" class="form-control editable-field " value="" name="documents_pending_request" id="documents_pending_request" placeholder="Documents Pending / Requested" >
                    </div>
                </div>       
            </div>
...
$(document).ready(function() {
    ...
    $(document).ready(function() {
        ...
        $('#date, #final_documents_submission_date, #dv_submission_date, #consignment_arrival_date, #policy_period_from,#survey_allotment_date,#survey_date,#previous_report_date, #vassel_sailing_date,#loss_data,#invoice_date,#consignment_date,#salvage_pickup_date,#delivery_cargo_date,#arrival_cargo_date').datepicker({
