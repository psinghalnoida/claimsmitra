...
<body>
    <div class="flyleaf">
        ...
        <div class="imgheader">
            <table >
                <tbody class="no-border">
                    <tr>
                        <td style="width:100%; vertical-align: top;"><b>Case Reference: <?php echo $essentialData['case_reference']; ?></b></td>
                    ...
                    <tr>
                        <td colspan="2"><b><p class="text-center" style="font-weight: 600;margin:0px;font-size:20px;"> MOTOR SPOT REPORT</p></b> </td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <th style="width: 25%;"><?php echo isset($essentialData['vehicle_number']) ? $essentialData['vehicle_number'] : 'NA'; ?></th>
        ...
        <?php if (!empty($caseData['load_body'])): ?>
            <div class="card" style="page-break-inside: avoid;border:none;">
                <div class="card-container">
         ...
         <div class="card " style="page-break-inside: avoid;">
                <div class="card-container mt-2">
                    ...
                    <p class="card-text" style="margin-bottom: 2px;">
                        <?php 
                        // Allow specific tags for bold, italic, underline, and line breaks
                        echo nl2br(strip_tags($caseData['remarks'], '<b><strong><i><u><br>')); 
                        ?>
                    </p>
                </div>
            </div>
