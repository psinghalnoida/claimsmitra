...
<div class="panel ">
    <form id="firefinal_essential" method="post" enctype="multipart/form-data">
        ...
        <div class="panel-body" style="padding-top:0px; padding-bottom: 0px;">
            ...
            <?php $this->load->view("adminpanel/jobs/locationbasedjob/propertycommandata") ?>
        </div>

        <div class="button d-flex justify-content-end" style="padding-bottom:10px;">
            <input class="btn case_btn toggle-edit" type="button" value="<?php echo isset($essentialdata) ? "Edit" : "Next"; ?>" id="firefinal_submit">
        </div>
    </form>
</div>
