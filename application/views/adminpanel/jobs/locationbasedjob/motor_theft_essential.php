            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control editable-field" <?php echo isset($essentialdata->vehicle_number) ? "disabled" : ""; ?> value="<?php echo isset($essentialdata->vehicle_number) && !empty($essentialdata->vehicle_number)? $essentialdata->vehicle_number : (isset($jobdata->vehicle_number) ? $jobdata->vehicle_number : ""); ?>" id="vehicle_no" name="vehicle_number" placeholder="Vehicle No." required>
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="registered_owner" style="color:black">Name of Registered Owner <span style="color:red">*</span></label>
                        <input type="text" class="form-control editable-field" <?php echo isset($essentialdata->registered_owner) ? "disabled" : ""; ?> value="<?php echo isset($essentialdata->registered_owner) && !empty($essentialdata->registered_owner)? $essentialdata->registered_owner: (isset($jobdata->registered_owner) ? $jobdata->registered_owner : ""); ?>" id="registered_owner" name="registered_owner" placeholder="Name of Registered Owner" required>
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control editable-field" <?php echo isset($essentialdata->insured_name) ? "disabled" : ""; ?> value="<?php echo isset($essentialdata->insured_name) && !empty($essentialdata->insured_name)? $essentialdata->insured_name : (isset($jobdata->insured_name) ? $jobdata->insured_name : ""); ?>" id="insured_name" name="insured_name" placeholder="Name of insured(As per policy)" required>
                    </div>
                </div>
