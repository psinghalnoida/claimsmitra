...
<head>
    ...
    <style>
        ...
        * {
        ...
        .flyleaf {
            overflow: hidden;
            /* or ensure no fixed height is causing issues */
        }
    </style>
</head>
    ...
    <div class="header">
        ...
        <div style="width: 100%;">
            ...
            <div style="text-align: center;margin-left:-100px;">
                <span style="font-size:10px;"><a style="padding-left:30%; maring-top:10px;" href="<?php echo base_url('downloadmedia/' . $aid . ''); ?>" alt="download report">Download</a></span>
        ...
        <div class="head" style="text-align:right;margin-left:15%;margin-bottom:5px;">
            <h3 style="font-weight: 600;margin:0px;"> Motor Final ILA</h3>
        </div>
        <table>
            <tbody>
                <tr>
                ...
                <tr>
                    ...
                    <td>Claim No.: </td>
                    <td><?php echo $essentialData['claim_no']; ?></td>
                    <td style="width: 10%;">Claim No.: </td>
                    <td style="width: 25%;"><?php echo $essentialData['claim_no']; ?></td>
                </tr>
            </tbody>
        </table>
        <table style="margin-top: 10px;">
            <tr>
                <td style="width:25%">Vehicle Regn No. Make & Model</td>
            ...
            <tr>
                ...
                <td colspan="7">
                    <?php echo $essentialData['period_of_insurance']; ?>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width:25%">Date of allotment of survey </td>
