...
<body>
    <div class="flyleaf">
        ...
        <div class="letterhead">
         ...
         <div class="imgheader">
            <table>
                <tbody class="no-border" style="border-collapse: collapse;  border: none;">
       ...
       <p style="font-size: 20px;text-align: center;font-weight: 500;padding:2px;margin:0px;">Miscellaneous Final ILA</p>
        
        <table>
            <tr>
                <td style="width:20%">Name of Insured</td>
                <td style="width:30%"> <?php echo $essentialData['insured_name']; ?></td>
                <td style="width:20%">Place of Loss</td>
                <td style="width:30%"><?php echo $essentialData['loss_place']; ?></td>
            </tr>
            <tr>
                <td >Name of Claimant / Mobile No.</td>
                <td><?php echo $essentialData['contact_person_name'].' ('.$essentialData['contact_person_mobile'].')'; ?></td>
                <td>Cause / Nature of Loss</td>
                <td > <?php 
                    echo ($essentialData['natureofloss'] == 'Other' && !empty($essentialData['otherPolicyType'])) 
                        ? $essentialData['other_nature_Type'] 
                        : $essentialData['natureofloss']; 
                    ?></td>
            </tr>
            <tr>
                <td>Policy type</td>
                <td>
                    <?php 
                    echo ($essentialData['policytype'] == 'Other' && !empty($essentialData['otherPolicyType'])) 
                        ? $essentialData['otherPolicyType'] 
                        : $essentialData['policytype']; 
                    ?>
                </td>
              ...
              <tr>
                ...
                <td ><?php echo $essentialData['investigation_date']; ?></td>
            </tr>
            ...
            <?php if (!empty($essentialData['remark'])) { ?>
                <tr>
                    <td>Remark</td>
                    <td colspan="3"><?php echo $essentialData['remark']; ?></td>
                </tr>
            <?php } ?>
        </table>
