<div class="panel ">
    <form id="fire_investigation_essential" method="post" enctype="multipart/form-data">
        ...
        <div class="panel-body" style="padding-top:0px; padding-bottom: 0px;">
            ...
            <?php $this->load->view("adminpanel/jobs/locationbasedjob/commaninvestigationdata") ?>
          
            

            <div class="button d-flex justify-content-end" style="padding-bottom:10px;">
                <input class="btn case_btn" type="button" value="<?php echo isset($essentialdata) ? "Edit" : "Next"; ?>" id="fire_investigation_submit">
            </div>
        </div>
    </form>
</div>
