<div class="panel mt-4" id="caseForm">
    <form id="caseDataForm" method="post" enctype="multipart/form-data">
        <div class="panel-heading case_form_heading">
            ...
            <div class="dropdown">
                <div class="button d-flex justify-content-end">
                     ...
                     <a href="<?php echo base_url('generatechecklist/'.$aid.'/' . $companyid); ?>" target="_blank"   class="btn checklist_btn case_btn">Generate Checklist</a>
        ...
        <div class="panel-body" style="padding-top:0px; padding-bottom: 0px;">
            ...
            <!-- additional field -->
            <div class="row my-3 <?php echo (isset($reportdata->pmr) && $reportdata->pmr == 'Yes') ? '' : 'additional_field'; ?>" >
                <div class="col-xl-2 col-md-2 ">
                    <div class="form-group">
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" <?php echo isset($reportdata->doctorContactNumber) ? "disabled" : "enable"; ?> value="<?php echo isset($reportdata->doctorContactNumber) ? $reportdata->doctorContactNumber : ""; ?>" name="doctorContactNumber" class="form-control case-field"  placeholder="Mobile Number of Doctor">
                    </div>
                </div>
            </div>
            <!-- additional field -->
            ...
            <div class="row my-3 <?php echo (isset($reportdata->treatment_chart) && $reportdata->treatment_chart == 'Yes') ? '' : 'basedontreatment'; ?>" >
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                           ...
                           <textarea 
                                ...
                                rows="2"><?php 
                                    if (isset($reportdata->remarkObservation)) {
                                        echo htmlspecialchars(trim($reportdata->remarkObservation), ENT_QUOTES, 'UTF-8');
                                    }
                                ?>
                            </textarea>
