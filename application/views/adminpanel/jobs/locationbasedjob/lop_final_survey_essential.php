...
<div class="panel ">
    <form id="lopfinal_essential" method="post" enctype="multipart/form-data">
            ...
            <div class="row ">
                <div class="col-xl-12 col-md-12">
                    <div class="form-group">
                        ...
                        ><?php echo isset($essentialdata->visit_date_time) ? $essentialdata->visit_date_time : ""; ?></textarea>
                    </div>
                </div>
            </div>
            <div class="row ">
        ...
        <div class="button d-flex justify-content-end" style="padding-bottom:10px;">
                <input class="btn case_btn" type="button" value="<?php echo isset($essentialdata) ? "Edit" : "Next"; ?>" id="lopfinal_submit">
        </div>
    </form>
</div>
  <!-- Modal Structure -->
...
<script> 
    $(document).ready(function () {
        ...
        $("#lopfinal_submit").click(function() {
            var editButtonText = $(this).val();
            if (editButtonText === "Next") {   
                $("#generate_ila").hide();
                $('#lopfinal_essential').trigger('submit');
        ...
        $("#lopfinal_essential").validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    url: '<?php echo base_url("lopfinalessential"); ?>',
                    type: 'POST',
                    data: formdata,
                    dataType: 'json',
                    processData: false,
                    ...
                    beforeSend: function() {
                        ...
                        $('#lopfinal_submit').prop('disabled', true);
                    ...
                    success: function (response) {
                        if (response.status === 200) {
                            ...
                            $('#lopfinal_submit').val("Edit"); // Change submit button text to "Edit"
