    ...
    <form id="ebdeathcase" method="post" enctype="multipart/form-data">
        ...
        <div class="panel-heading case_form_heading">
            ...
            <div class="dropdown">
                <div class="button d-flex justify-content-end">
                    ...
                    <?php } elseif ($assignmentType == 'outgoing') { ?>
                        
                            <a href="<?php echo base_url('generatepdf/' . $aid); ?>" target="_blank" style="display: <?php echo isset($reportdata) ? "block" : "none"; ?>;" class="btn case_btn">Generate Report</a>
        ...
        <div class="panel-body" style="padding-top:0px; padding-bottom: 0px;">
            ...
            <div class="row ">
                ...
                <div class="col-xl-4 col-md-4 ">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control case-field" <?php echo isset($reportdata->policyNumber) ? "disabled" : "enable"; ?> value="<?php echo isset($reportdata->policyNumber) && !empty($reportdata->policyNumber) ? $reportdata->policyNumber : (isset($essentialdata->policyNumber) ? $essentialdata->policyNumber : ""); ?>" id="policyNumber" name="policyNumber" placeholder="Policy Number">
                    </div>
                </div>
                <div class="col-xl-2 col-md-2">
                    <div class="form-group">
                        <label for="policyNumberfrom" style="color:black">Policy Date (From) </label>
                        <input type="text" class="form-control case-field policyNumberfrom" <?php echo isset($reportdata->policyNumberfrom) ? "disabled" : "enable"; ?> value="<?php echo isset($reportdata->policyNumberfrom) && !empty($reportdata->policyNumberfrom) ? $reportdata->policyNumberfrom  : (isset($essentialdata->policyNumberfrom) ? $essentialdata->policyNumberfrom : ""); ?>" id="policyNumberfrom" name="policyNumberfrom" placeholder="From">
                    </div>
                </div>
                <div class="col-xl-2 col-md-2">
                    <div class="form-group">
                        <label for="policyNumberto" style="color:black">Policy Date (To) </label>
                        <input type="text" class="form-control case-field policyNumberto" <?php echo isset($reportdata->policyNumberto) ? "disabled" : "enable"; ?> value="<?php echo isset($reportdata->policyNumberto) && !empty($reportdata->policyNumberto) ? $reportdata->policyNumberto : (isset($essentialdata->policyNumberto) ? $essentialdata->policyNumberto : ""); ?>" id="policyNumberto" name="policyNumberto" placeholder="To">
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                ...
                <div class="col-xl-12 col-md-12">
                    <div class="form-group">
                        <label for="policyissuing_office" style="color:black">
                            Policy Issuing office &nbsp;<span style="color:red">*</span>
                        </label>
                        <textarea
                            class="form-control case-field"
                            id="policyissuing_office"
                            name="policyissuing_office"
                            placeholder="Policy Issuing office"
                            <?php echo isset($reportdata->policyissuing_office) ? "disabled" : ""; ?>
                            rows="4"><?php echo isset($reportdata->policyissuing_office) ? $reportdata->policyissuing_office : ""; ?></textarea>
                ...
                <div class="col-xl-12 col-md-12">
                    <div class="form-group">
                        <label for="insured_name" style="color:black">
                            Name of Insured &nbsp;<span style="color:red">*</span>
                        </label>
                        <textarea
                            class="form-control case-field"
                            id="insured_name"
                            ...
                            <?php echo isset($reportdata->insured_name) ? "disabled" : ""; ?>
                            rows="2"><?php echo isset($reportdata->insured_name) ? $reportdata->insured_name : ""; ?></textarea>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-2 col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control case-field selectdate date_of_report" <?php echo isset($reportdata->detailed_incidencedate) ? "disabled" : "enable"; ?> value="<?php echo isset($reportdata->detailed_incidencedate) ? $reportdata->detailed_incidencedate : ""; ?>" id="detailed_incidencedate" name="detailed_incidencedate" placeholder="Detailed Incidence Date">
                    </div>
                </div>
                <div class="col-xl-2 col-md-2">
                    <div class="form-group">
                ...
                <div class="col-xl-2 col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control case-field" <?php echo isset($reportdata->accident_time) ? "disabled" : "enable"; ?> value="<?php echo isset($reportdata->accident_time) ? $reportdata->accident_time : ""; ?>" name="accident_time" placeholder="Time of accident">
                    </div>
                </div>
                <div class="col-xl-2 col-md-2">
                    <div class="form-group">
                        <label for="accident_place" style="color:black">Place of accident</label>
                        <input type="text" class="form-control case-field" <?php echo isset($reportdata->accident_place) ? "disabled" : "enable"; ?> value="<?php echo isset($reportdata->accident_place) ? $reportdata->accident_place : ""; ?>" id="accident_place" name="accident_place" placeholder="Place of accident">
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="death_date" style="color:black">Date of death</label>
                        <input type="text" class="form-control case-field selectdate" <?php echo isset($reportdata->death_date) ? "disabled" : "enable"; ?> value="<?php echo isset($reportdata->death_date) ? $reportdata->death_date : ""; ?>" id="death_date" name="death_date" placeholder="Date of death">
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="policereport_number" style="color:black">Date of Policy report</label>
                        <input type="text" class="form-control case-field date_of_report" <?php echo isset($reportdata->report_date) ? "disabled" : "enable"; ?> value="<?php echo isset($reportdata->report_date) ? $reportdata->report_date : ""; ?>" id="report_date" name="report_date" placeholder="Date of Policy report">
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="report_by" style="color:black">Police report by </label>
                        <input type="text" class="form-control case-field" <?php echo isset($reportdata->report_by) ? "disabled" : "enable"; ?> value="<?php echo isset($reportdata->report_by) ? $reportdata->report_by : ""; ?>" id="report_by" name="report_by" placeholder="Police report by">
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control case-field" id="claimant_relation" name="claimant_relation" <?php echo isset($reportdata->claimant_relation) ? 'disabled' : ''; ?>>
                            ...
                            <option value="F/O" <?php echo ($reportdata->claimant_relation ?? '') == 'F/O' ? 'selected' : ''; ?>>F/O</option>
                        </select>
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                ...
                <div class="col-xl-12 col-md-12">
                    <div class="form-group">
                        <label for="deceased_verification" style="color:black">
                            Age of deceased / Verification &nbsp;<span style="color:red">*</span>
                        </label>
                        <textarea
                            class="form-control case-field"
                            id="deceased_verification"
                            name="deceased_verification"
                            placeholder="Age of deceased / Verification"
                            rows="1"
                            <?php echo isset($reportdata->deceased_verification) ? "disabled" : ""; ?>><?php echo isset($reportdata->deceased_verification) ? $reportdata->deceased_verification : ""; ?></textarea>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control case-field" <?php echo isset($reportdata->death_reason) ? "disabled" : "enable"; ?> value="<?php echo isset($reportdata->death_reason) ? $reportdata->death_reason : ""; ?>" id="death_reason" name="death_reason" placeholder="did the person die and was the death instant">
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-xl-12 col-md-12">
                    <div class="form-group">
                        <label for="conclusion" style="color:black">Conclusion &nbsp;<span style="color:red">*</span></label>
                        <textarea type="text" class="form-control case-field" <?php echo isset($reportdata->conclusion) ? "disabled" : "enable"; ?> id="conclusion" name="conclusion" placeholder="Conclusion"><?php echo isset($reportdata->conclusion) ? $reportdata->conclusion : ""; ?></textarea>
                    </div>
                </div>
                <div class="col-xl-12 col-md-12">
                    <div class="form-group">
                ...
                <div class="col-xl-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control case-field" <?php echo isset($reportdata->disclaimer) ? "disabled" : "enable"; ?> value="<?php echo isset($reportdata->disclaimer) ? $reportdata->disclaimer : "The information provided is true to our knowledge and belief and is based upon the various inputs received from various sources. We have tried reasonably good to obtain and verify the information. We have compiled the information as per requirements of our employers. It is further presumed that they would use the above information only for the best intentions and as such we cannot be tried by any third parties in court for issuing this report."; ?>" id="disclaimer" name="disclaimer" placeholder="Disclaimer">
                    </div>
                </div>
            </div>
            <div class="button d-flex justify-content-end" style="padding-bottom:10px;">
                <input class="btn case_btn" value="<?php echo isset($reportdata) ? "Edit" : "Submit"; ?>" type="button" id="ebdeath_case_submit">
            </div>
        </div>
    </form>
</div>
...
<script>
    function applyEditMode() {
        let buttonText = $("#ebdeath_case_submit").val();
        if (buttonText === "Edit") {
    ...
    $(document).ready(function() {
        ...
        $("#ebdeath_case_submit").click(function() {
        ...
        $("#ebdeathcase").validate({
            ...
            submitHandler: function(form) {
                ...
                if (assignmentType === 'outgoing') {
                    ajaxUrl = '<?php echo base_url("updateebdeathcasedata_outgoing"); ?>';
                } else {
                    ajaxUrl = '<?php echo base_url("updateebdeathcasedata"); ?>';
                }
