                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-content">
                            <div class="row">
                                <div class="col-12">
                                    <table id="pendingcase" class="table table-bordered table-hover" style="width:100%">
                                        <thead>
                                            <tr>
...
* ------------------------------------------------------------------------- */
var $recordsListView = $('#pendingcase');
...
if ( $recordsListView.length ) {
    $recordsListView.DataTable({
        ...
        "autoWidth": true,
        language: {
            searchPlaceholder: "Search pending case"
        },
        order: [],
        // Load data from an Ajax source
        "ajax": {
            url: "<?php echo base_url('nonlocationpendingcase'); ?>",
            type: "POST",
            dataType:"JSON",
        },
