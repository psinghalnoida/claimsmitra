            ...
            <div class="row my-3">
                ...
                <div class="col-xl-2 col-md-2">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append disabledbtn">
                ...
                <div class="col-xl-2 col-md-2">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control case-field permitvalidity"
                ...
                <div class="col-xl-4 col-md-4">
                    ...
                    <div class="input-group ">
                        <input type="text" class="form-control case-field survey_date" <?php echo isset($reportdata->survey_date) ? "disabled" : "enable"; ?> value="<?php echo isset($reportdata->survey_date) ? $reportdata->survey_date : ""; ?>" id="survey_date" name="survey_date" placeholder="Date of survey">
                        <div class="input-group-append disabledbtn">
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control case-field" <?php echo isset($reportdata->type_of_vehicle_allowed) ? "disabled" : "enable"; ?> value="<?php echo isset($reportdata->type_of_vehicle) && !empty($reportdata->type_of_vehicle)
                                                                                                                                                                            ? $reportdata->type_of_vehicle
                                                                                                                                                                            : (isset($jobdata->type_of_vehicle_allowed) ? $jobdata->type_of_vehicle_allowed : ""); ?>" id="type_of_vehicle_allowed" name="type_of_vehicle_allowed" placeholder="Type of vehicle allowed to drive">
                    </div>
                </div>
                ...
                <div class="col-xl-2 col-md-2">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control editable-field fir_date"
                                <?php echo isset($reportdata->fir_date) ? 'readonly' : ''; ?>
                                value="<?php echo isset($reportdata->fir_date) ? $reportdata->fir_date : ''; ?>"
                                name="fir_date"
                                placeholder="FIR date"
                                required>
                            <div class="input-group-append disabledbtn">
                                <a class="btn btn-rounded btn-info fir_datebtn" href="#"
                ...
                <div class="col-xl-2 col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control editable-field"
                            <?php echo isset($reportdata->fir_no) ? "disabled" : ""; ?>
                            value="<?php echo isset($reportdata->fir_no) ? $reportdata->fir_no : ""; ?>"
                            id="fir_no" name="fir_no"
