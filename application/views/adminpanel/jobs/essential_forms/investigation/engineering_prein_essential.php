            ...
            <div class="row my-3">
                ...
                <div class="col-xl-4 col-md-4 ">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control editable-field" <?php echo isset($essentialdata->subject_matter) ? "disabled" : "enable"; ?> value="<?php echo isset($essentialdata->subject_matter) && !empty($essentialdata->subject_matter) ? $essentialdata->subject_matter : (isset($jobdata->subject_matter) ? $jobdata->subject_matter : ""); ?>" id="subject_matter" name="subject_matter" placeholder="Subject Matter">
                    </div>
                </div>
            </div>
            <div class="row my-3">
