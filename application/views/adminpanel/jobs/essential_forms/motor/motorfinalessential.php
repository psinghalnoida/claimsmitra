            ...
            <div class="row my-3">
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control editable-field" <?php echo isset($essentialdata->contact_person_name) ? "disabled" : ""; ?> value="<?php echo isset($essentialdata->contact_person_name) && !empty($essentialdata->contact_person_name)
                                                                                                                                                                        ? $essentialdata->contact_person_name : (isset($jobdata->contact_person_name) ? $jobdata->contact_person_name : ""); ?>" id="contact_person_name" name="contact_person_name" placeholder="Contact Person Name" required>
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                ...
                <div class="col-xl-2 col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control editable-field insuranceto " <?php echo isset($essentialdata->insuranceto) ? "disabled" : ""; ?> value="<?php echo isset($essentialdata->insuranceto) ? $essentialdata->insuranceto : ""; ?>" name="insuranceto" placeholder="Select time" required>
                    </div>
                </div>
                <div class="col-xl-2 col-md-2">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control editable-field insured_name"
                                ...
                                value="<?php echo isset($essentialdata->insured_name) ? $essentialdata->insured_name : ""; ?>"
            ...
            <div class="row my-3">
                <div class="col-xl-2 col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control editable-field" <?php echo isset($essentialdata->claim_no) ? "disabled" : ""; ?> value="<?php echo isset($essentialdata->claim_no) && !empty($essentialdata->claim_no)
                                                                                                                                                            ? $essentialdata->claim_no : (isset($jobdata->claim_no) ? $jobdata->claim_no : ""); ?>" id="claim_no" name="claim_no" placeholder="Claim Number" required>
                    </div>
                </div>
                <div class="col-xl-2 col-md-2">
                    <div class="form-group">
                        <label for="vehicle_number" style="color: black;">Vehicle Number &nbsp;<span style="color:red">*</label>
                        <input type="text" class="form-control editable-field" <?php echo isset($essentialdata->claim_no) ? "disabled" : ""; ?> value="<?php echo isset($essentialdata->vehicle_number) && !empty($essentialdata->vehicle_number)
                                                                                                                                                            ? $essentialdata->vehicle_number : (isset($jobdata->vehicle_number) ? $jobdata->vehicle_number : ""); ?>" id="vehicle_number" name="vehicle_number" placeholder="Vehicle Number" required>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="loss_data" style="color:black">Cause of loss &nbsp;<span style="color:red">*</span></label>
                        <input type="text" class="form-control editable-field " <?php echo isset($essentialdata->loss_data) ? "disabled" : ""; ?> value="<?php echo isset($essentialdata->loss_data) && !empty($essentialdata->loss_data)
                                                                                                                                                                ? $essentialdata->loss_data : (isset($jobdata->cause_loss) ? $jobdata->loss_data : ""); ?>" name="loss_data" placeholder="Cause of loss" required>
                    </div>
                </div>
            </div>
            <div class="row my-3">
            ...
            <div class="row my-3">
                ...
                <div class="col-xl-2 col-md-2">
                    <div class="form-group">
                        ...
                        <input type="time" class="form-control editable-field " <?php echo isset($essentialdata->time_of_incident) ? "disabled" : ""; ?> value="<?php echo isset($essentialdata->time_of_incident) ? $essentialdata->time_of_incident : ""; ?>" id name="time_of_incident" required placeholder="Time of Accident">
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
