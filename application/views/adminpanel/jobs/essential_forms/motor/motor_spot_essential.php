            ...
            <div class="row my-3">
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control editable-field register_no" <?php echo isset($essentialdata->vehicle_number) ? "disabled" : ""; ?> value="<?php echo isset($essentialdata->vehicle_number) && !empty($essentialdata->vehicle_number)
                                 ? $essentialdata->vehicle_number : (isset($jobdata->vehicle_number) ? $jobdata->vehicle_number : ""); ?>" name="vehicle_number" id="registration_number" placeholder="Registration No." required>
                    </div>
                </div>
                ...
                <div class="col-xl-2 col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control editable-field" <?php echo isset($essentialdata->claim_no) ? "disabled" : ""; ?> value="<?php echo isset($essentialdata->claim_no) && !empty($essentialdata->claim_no)  ? $essentialdata->claim_no
                                 : (isset($jobdata->claim_no) ? $jobdata->claim_no : ""); ?>" id="claim_no" name="claim_no" placeholder="Claim Number">
                    </div>
                </div>
                <div class="col-xl-2 col-md-2">
                    <div class="form-group">
                ...
                <div class="col-xl-2 col-md-2">
                    <div class="form-group ">
                        <input type="text" class="form-control editable-field  mt-4 insurancetotime" <?php echo isset($essentialdata->insurancetotime) ? "disabled" : ""; ?> value="<?php echo isset($essentialdata->insurancetotime) ? $essentialdata->insurancetotime : ""; ?>" name="insurancetotime" placeholder="Select Time" required>
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
