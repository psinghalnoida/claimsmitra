    ...
    <form id="marine_spot_inspection" method="post" enctype="multipart/form-data">
        ...
        <div class="panel-body" style="padding-top:0px; padding-bottom: 0px;">
            ...
            <div class="row my-3">
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="packing_description" style="color:black">Packing Description &nbsp;<span style="color:red">*</span></label>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="consignment_date" style="color:black">Consignment Date &nbsp;<span style="color:red">*</span></label>
            ...
            <div class="row my-3">
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="type_of_loss" style="color:black">Type of Damage &nbsp;<span style="color:red">*</span></label>
            ...
            <div class="row my-3">
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="form-group">
                        <label for="survey_date" style="color:black">Survey Date &nbsp;<span style="color:red">*</span></label>
