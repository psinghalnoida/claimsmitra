<div id="invoiceContainer">
    <div class="form-group row" id="invoice">
        ...
        <div class="col-lg-1" style="text-align:end">
            ...
            <button type="button" onclick="addNewInvoice()" id="add_more" style="width:100%;height:39px;" class="btn btn-rounded btn-success editable-field disabledbtn"><i class="fa fa-plus"></i></button>
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-xl-1 col-md-1 form-inline">
        <label class="form-check">
            ...
            <input type="checkbox" name="print_estimated_amt" value="1" class="form-check-input disabledbtn"
                <?php echo (isset($essentialdata->print_estimated_amt) && $essentialdata->print_estimated_amt != 0) ? 'checked' : ''; ?>
                <?php echo isset($essentialdata->print_estimated_amt) ? 'disabled' : ''; ?>>
    ...
    <div class="col-xl-1 col-md-1 form-inline">
        <label class="form-check">
            <!-- Checkbox will be checked by default unless print_estimated_amt is 0 -->
            <input type="checkbox" name="print_salvage_amt" value="1" class="form-check-input disabledbtn"
                <?php echo (isset($essentialdata->print_salvage_amt) && $essentialdata->print_salvage_amt != 0) ? 'checked' : ''; ?>
                <?php echo isset($essentialdata->print_salvage_amt) ? 'disabled' : ''; ?>>
            <span class="form-check-label">Print</span>
        </label>
    </div>
</div>
<div id="grContainer">
    <div class="form-group row" id="gr">
        ...
        <div class="col-lg-1" style="text-align:end">
            ...
            <button type="button" onclick="addNewgr()" id="add_more_gr" style="width:100%;height:39px;" class="btn btn-rounded btn-success editable-field disabledbtn"><i class="fa fa-plus"></i></button>
        </div>
    </div>
</div>
