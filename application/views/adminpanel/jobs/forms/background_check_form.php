<form id="backgroundcheckform" method="post" enctype="multipart/form-data" style="display:block">
    ...
    <div class="form-group row" id="beneficiary_name">
        <span class="label-text col-lg-3 col-form-label">Name of Beneficiary</span>
        <div class="col-lg-9">
            <input type="text" name="name_of_beneficiary" id="name_of_beneficiary" placeholder="Name of Beneficiary" class="form-control name_of_beneficiary">
        </div>
    </div>
    ...
    <div class="modal-footer" style="padding-right:0px;">
        ...
        <button type="submit" class="btn btn-rounded btn-success" id="btn_backgroundcheck_form">Submit With Payment</button>
        <button type="submit" class="btn btn-rounded btn-success" id="btn_backgroundcheck_without_form">Submit Without Payment</button>
    </div>
</form>
