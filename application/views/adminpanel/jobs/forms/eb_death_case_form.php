<form id="ebdeathform" method="post" enctype="multipart/form-data" style="display:block">
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-9">
            <input type="text" class="form-control" id="loss_item" name="loss_item" placeholder="Loss Item">
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="modal-footer" style="padding-right:0px;">
      <!--   <button type="reset" class="btn btn-rounded btn-secondary" id="btn_reset_form">Reset</button><br>
        <button type="submit" class="btn btn-rounded btn-success" id="btn_mediclaim_form">Submit With Payment</button> -->
        <button type="submit" class="btn btn-rounded btn-success" id="btn_ebdeath_without_form">Submit</button>
    </div>
</form>
