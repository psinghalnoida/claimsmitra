<form id="medicalopinionform" method="post" enctype="multipart/form-data" style="display:block">
    ...
    <div class="modal-footer" style="padding-right:0px;">
        ...
        <button type="submit" class="btn btn-rounded btn-success" id="btn_mediclaim_without_form">Submit Without Payment</button>
    </div>
</form>
