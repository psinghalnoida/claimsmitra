<form id="risk_inspection" method="post" enctype="multipart/form-data" style="display:block">
    ...
    <div class="modal-footer  ml-auto" style="padding: 0px;border-top:0px;">
        ...
        <!-- <button type="submit" class="btn btn-rounded btn-success" id="btn_risk_inspectio_form">Submit With Payment</button> -->
        <button type="submit" class="btn btn-rounded btn-success" id="btn_risk_inspectio_without_form">Submit</button>
    </div>
</form>
