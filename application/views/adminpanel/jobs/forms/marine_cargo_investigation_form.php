<form id="marinecargoform" method="post" enctype="multipart/form-data" style="display:block">
    ...
    <div class="modal-footer" style="padding-right:0px;">
        ...
        <button type="submit" class="btn btn-rounded btn-success" id="btn_marinecargo_form">Submit With Payment</button>
        <button type="submit" class="btn btn-rounded btn-success" id="btn_marinecargo_without_form">Submit Without Payment</button>
    </div>
</form>
