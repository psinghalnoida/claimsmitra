<form id="technicalinsuranceform" method="post" enctype="multipart/form-data" style="display:block">
    ...
    <div class="modal-footer" style="padding-right:0px;">
        ...
        <button type="submit" class="btn btn-rounded btn-success" id="btn_technicalinsurance_form">Submit With Payment</button>
        <button type="submit" class="btn btn-rounded btn-success" id="btn_technicalinsurance_without_form">Submit Without Payment</button>
    </div>
</form>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        /* ------------------------------------------------------------------------- *
             * ENGINEERING JOB DATA (BY KAJAL)
             * ------------------------------------------------------------------------- */
            // Handle Submit With Payment Button Click
