<form id="motorfinalform" method="post" enctype="multipart/form-data" style="display:block">
    ...
    <div class="modal-footer  ml-auto" style="padding: 0px;border-top:0px;">
        ...
        <?php if($usertype == 1): ?>
        <button type="submit" class="btn btn-rounded btn-success" id="btn_motorfinal_form">Submit With Payment</button>
        <?php else: ?>
        <button type="submit" class="btn btn-rounded btn-success" id="btn_motorfinal_without_form">Submit</button>
        <?php endif; ?>
    </div>
</form>
