...
<body>
    <div class="flyleaf">
       ...
       <?php else : ?>
          ...
          <?php endif; ?>
            <div style="background-color:black; width: 99%; padding: 3px;margin-top:5px;">
               <p style="text-align: center; color:white; margin: 0;font-size:13px;">
            <b>
                <?php if (isset($currency->currency_conversion) && $currency->currency_conversion == 'INR'): ?>
                    TAX INVOICE
                <?php else: ?>
                    EXPORT INVOICE
                <?php endif; ?>
        ...
        <div class="imgheader" style="border-style: dotted; border-color:black; padding: 2px;margin-top:5px;">
            <table class="">
                <tbody>
                    <tr>
                        <td style="width:55%; vertical-align: top;"><b>Bill to:</b></td>
                        ...
                        <td class="border-top-none" rowspan="5" style="position: relative; text-align: center; padding: 0; vertical-align: top; width: 18%;">
                            <div style=" height: 120px; display: flex; align-items: center; justify-content: center;padding:0px 5px;">
                                <!-- <img src="data:image/png;base64,<?php echo base64_encode(file_get_contents('assets/images (1).png')); ?>"
                                    alt="Company Logo" style="max-width: 100%; height:115px;margin:4px;"> -->
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <?php echo htmlspecialchars($shippingData->shipping_branch_name ?? '-'); ?>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2"><b>Our Reference :</b> <?php echo htmlspecialchars($essentialData['case_reference']); ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="imgheader" style="border: 1px solid black;margin-top:5px; padding: 2px; ">
            <table class="">
                <tbody>
                    <!-- <tr>
                    <th class="border-top-none" style="width:17.5%"><b>GSTIN</b> </th>
                    <td class="border-top-none" colspan="3"><?php echo isset($billingData->billing_gst) ? htmlspecialchars($billingData->billing_gst) : '-'; ?><br></td>
                    
                </tr> -->
                    <!-- <tr>
                    <th class="border-top-none" style="width:17.5%"><b>Billing Id</b> </th>
                    <td class="border-top-none" colspan="3">1D14014037<br></td>
                    <td class="border-top-none" style="width:20%;" colspan="1"><b>Invoice No:</b> D20240699 </td>


                </tr> -->
                    <tr>
                        <th class="border-top-none" style="width:17.5%">Type of Case</th>
                        <td class="border-top-none" style="width:40%;" colspan="4"><b>  <?php if (!empty($investigator_type)) { ?>
                                  <?php echo htmlspecialchars($investigator_type); ?>
                                <?php }  ?><b></td>
                        <td colspan="2" class="border-top-none" style="width:17.98%;"><b>Invoice No:</b> <?php echo isset($amount->ti_number) ? htmlspecialchars($amount->ti_number) : '-'; ?> </td>
                    </tr>
                        ...
                        <?php if ((isset($essentialData['insured_name']) && !empty($essentialData['insured_name'])) || isset($caseData['insured_name'])): ?>
                            ...
                            <td colspan="4">
                                ...
                                echo isset($essentialData['insured_name']) && !empty($essentialData['insured_name'])
                                    ? htmlspecialchars_decode($essentialData['insured_name'])
                                    : (isset($caseData['insured_name']) ? htmlspecialchars_decode($caseData['insured_name']) : '');
                                ?>
                            </td>
                            <?php if (isset($amount->ti_datetime) && !empty($amount->ti_datetime) || isset($amount->ti_datetime)): ?>
                                <td class="border-top-none" colspan="2"><b>TI Date: </b> <?php echo isset($amount->ti_datetime) ? htmlspecialchars($amount->ti_datetime) : '-'; ?></td>
                            <?php endif; ?>
                        <?php else: ?>
                            <?php if (isset($amount->ti_datetime) && !empty($amount->ti_datetime) || isset($amount->ti_datetime)): ?>
                                <td class="border-top-none" colspan="7"><b>TI Date: </b> <?php echo isset($amount->ti_datetime) ? htmlspecialchars($amount->ti_datetime) : '-'; ?></td>
                            <?php endif; ?>
                        <?php endif; ?>
                    </tr>
                    ...
                    <?php endif; ?>
                     ...
                     <?php if (
                            (isset($essentialData['register_no']) && !empty($essentialData['register_no'])) ||
                            (isset($caseData['register_no']) && !empty($caseData['register_no'])) ||
                            (isset($jobData['register_no']) && !empty($jobData['register_no']))
                        ): ?>
                        <tr>
                            <th>Vehicle No</th>
                            <th colspan="6">
                                <?php
                                echo isset($essentialData['register_no']) && !empty($essentialData['register_no'])
                                    ? htmlspecialchars($essentialData['register_no'])
                                    : (isset($caseData['register_no']) && !empty($caseData['register_no'])
                                        ? htmlspecialchars($caseData['register_no'])
                                        : (isset($jobData['register_no']) && !empty($jobData['register_no'])
                                            ? htmlspecialchars($jobData['register_no'])
                                            : ''));
                                ?>
                            </th>
                        </tr>
                 ...
                 <?php 
                                ...
                                if (!empty($essentialData['invoices']) && is_array($essentialData['invoices'])) {
                                    foreach ($essentialData['invoices'] as $invoice) {
                                        ...
                                        <tr>
                                            ...
                                            <th>Invoice Date</th>
                                            <td colspan="4"><?php echo formatDate($invoicedate); ?></td>
                                        </tr>
                                        <?php if ($grNumber) { ?>
                                            <tr>
                                                <th>GR Number</th>
                                                ...
                                                <th>GR Date</th>
                                                <td colspan="4"><?php echo formatDate($grdate); ?></td>
                                            </tr>
                                        <?php } ?>
                                        <?php
                                    }
                  ...
                  <!--  <?php 
                        if (isset($essentialData['date_of_incident']) || isset($essentialData['time_of_incident'])): ?>
                            <tr>
                                <th>Date of Loss</th>
                                <td colspan="5">
                                    <?php
                        ...
                        <?php elseif (isset($essentialData['date_of_disease'])): ?>
                            <tr>
                                <th>Date of Loss</th>
                                <td colspan="5">
                                    <?php echo htmlspecialchars($essentialData['date_of_disease']); ?>
                                </td>
                            </tr>
                        <?php endif; ?> -->
                    ...
                    <?php if (isset($essentialData['claim_no'])): ?>
                        <tr>
                            <th>Claim No.</th>
                            <td colspan="6"><?php echo htmlspecialchars($essentialData['claim_no']); ?></td>
                        </tr>
                    <?php endif; ?>
        ...
        <div class="imgheader" style="border: 1px solid black;margin-top:5px; padding: 2px; ">
            <table style="">
                <tbody>
                    <tr>
                        <th class="border-top-none" style="width:17.5%"><b>Item</b></th>
                        <th class="border-top-none"><b>Description</b></th>
                        <th class="border-top-none" style="text-align:right;width:7%;text-align:center;"><b>SAC</b></th>
                        <th class="border-top-none" style="text-align:right;width:10.5%;text-align:center;"><b>Rate(Rs.)</b></th>
                        <th class="border-top-none" style="text-align:right;width:7%;text-align:center;"><b>Qty</b></th>
                        <th class="border-top-none" style="text-align:right;width:10.5%"><b>Amount(Rs.)</b></th>
                    </tr>
                    <?php if (!empty($invoicedata)): ?>
                        <?php foreach ($invoicedata as $invoice): ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($invoice->description); ?></t>
                                ...
                                <td style="text-align:right"><?php echo htmlspecialchars($invoice->amount); ?></th>
                            </tr>
                        <?php endforeach; ?>
            ...
            <table style="width: 100%; margin: 2px;">
                <tbody>
                    ...
                    <tr>
                        ...
                        <th  style=" height: 10px;border-bottom:none;font-weight: 400;">Kindly make payment/cheque in the name of </th> <!-- Half-width blank space -->
                    </tr>
                    <tr>
                   ...
                   <tr>
                        <!-- <?php foreach ($companydata as $data): ?>
                            <th style="height: 10px; border-bottom: none; font-weight: 400;">
                                <?php if (!empty($data['accountno'])): ?>
                                    <b>Account No:</b> <?php echo htmlspecialchars($data['accountno']); ?>,
                                <?php endif; ?>

                                <?php if (!empty($data['ifsccode'])): ?>
                                    <b>IFSC Code:</b> <?php echo htmlspecialchars($data['ifsccode']); ?>,
                                <?php endif; ?>

                                <?php if (!empty($data['micrcode'])): ?>
                                    <b>MICR Code:</b> <?php echo htmlspecialchars($data['micrcode']); ?>
                                <?php endif; ?>
                            </th>
                        <?php endforeach; ?> -->
                       <th style="height: 10px; border-bottom: none; font-weight: 400;">
