    ...
    <div class="tab-pane fade show active" id="tab11">
        <section class="page--header">
            <div class="container-fluid" style="padding-right:6px;">
                <div class="row">
                    <div class="col-lg-6">
                        <h2 class="page--title h5">Payment Cancel</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="ecommerce.html">Claims Mitra</a></li>
                            <li class="breadcrumb-item active"><span>Cancel</span></li>
                        </ul>
                    </div>
                </div>
            </div>
        </section>
        <section class="main--content" style="padding-right:600px; padding-left: 600px;">
                                ...
                                <div class="profile--panel">
                                    <div class="img-wrapper">
                                        <div class="img online" >
                                            <img src="<?php echo base_url();?>assets/img/avatars/cancel.png" alt=""  class="rounded-circle">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="name">
                                        <h3 class="h3" style="color: red;">Payment Cancel !</h3>
                                    </div>
                                    <div class="role">
