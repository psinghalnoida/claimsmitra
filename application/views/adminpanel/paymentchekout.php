...
<html lang="en">
  <head>
    ...
    <!-- build:css -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/paymentchekout/css/main.css">
    <!-- endbuild -->

    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/paymentchekout/css/theme.css">
  ...
  <body>
    ...
    <!-- build:js -->
    <script src="<?php echo base_url(); ?>assets/paymentchekout/js/main.js"></script>
    <!-- endbuild -->

    <script src="<?php echo base_url(); ?>assets/paymentchekout/js/theme.js"></script>
    ...
    <script>
        ...
        function stripeResponseHandler(status, response) {
            ...
            if (response.error) {
                ...
                $.post( appFilePath + "cases/checkout", dataPost, function(response) {
